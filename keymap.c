...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,------------------------------------------------------.                    ,-----------------------------------------------------.
      ___x___, ___x___, KC_WH_D, KC_MS_U, KC_WH_U, ___x___,                      ___x___, KC_PGDN,   KC_UP, KC_PGUP, KC_HOME, ___x___,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      ___x___, KC_BTN5, KC_MS_L, KC_MS_D, KC_MS_R, ___x___,                      ___x___, KC_LEFT, KC_DOWN, KC_RGHT,  KC_END, ___x___,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
